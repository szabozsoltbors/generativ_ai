    ...
    >
      ...
      >
        ...
        <form onSubmit={onSubmit}>
          {/* Product Name */}
          <div style={{ position: 'absolute', left: '22px', top: '57px', width: '344px', height: '50px' }}>
            <div 
          ...
          {/* Description */}
          <div style={{ position: 'absolute', left: '24px', top: '127px', width: '344px', height: '87px' }}>
            <div 
              className="font-inter font-medium text-black"
              style={{ 
                fontSize: '12px', 
            ...
            <div style={{ position: 'absolute', left: '0px', top: '18px', width: '344px', height: '69px' }}>
              <textarea 
          ...
          {/* Price */}
          <div style={{ position: 'absolute', left: '22px', top: '233px', width: '165px', height: '50px' }}>
            <div 
              className="font-inter font-medium text-black"
              style={{ 
                fontSize: '12px', 
          ...
          {/* Stock */}
          <div style={{ position: 'absolute', left: '201px', top: '233px', width: '165px', height: '50px' }}>
            <div 
              className="font-inter font-medium text-black"
              style={{ 
                fontSize: '12px', 
          ...
          {/* Cancel Button */}
          <div style={{ position: 'absolute', left: '178px', top: '297px', width: '68px', height: '32px' }}>
            <button 
              type="button" 
          ...
          <div style={{ position: 'absolute', left: '253px', top: '297px', width: '113px', height: '32px' }}>
            <button 
              type="submit" 
              className="font-inter font-medium"
              style={{
